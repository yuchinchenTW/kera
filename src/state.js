...
export function markDeath(state, playerId, cause, opts = {}) {
  ...
  if (Array.isArray(state.policePublicClearedBlueIds)) {
    state.policePublicClearedBlueIds = state.policePublicClearedBlueIds.filter((id) => id !== playerId);
  }
